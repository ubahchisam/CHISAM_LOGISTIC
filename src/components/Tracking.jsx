        ...
        <div className="row">
          ...
          <div className="col-md-6" data-aos="fade-up">
            <form onSubmit={handleSubmit}>
              <input type="text" placeholder='Enter your Tracking ID Here' className="form-control mt-3 mb-3" value={trackingId} onChange={handleInputChange}/>
              {error && <div className="text-danger">{error}</div>}
              <button type="submit" className="btn btn-danger">Track</button>
            </form>
          </div>
        </div>
      </div>
